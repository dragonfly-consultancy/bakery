...
?>
<style>
    /* ===== Sonoma-style overlay header (home only) ===== */
    body.has-overlay-header { padding-top: 0 !important; }
    body.has-overlay-header .ps-page > .ps-home { margin-top: 0; }
    body.has-overlay-header .ps-section--banner.ps-banner--container { margin-top: 0 !important; padding-top: 0 !important; }
