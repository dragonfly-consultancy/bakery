...
<form method="post" action="https://www.payhere.lk/pay/checkout">   
    ...
    <input type="hidden" name="return_url" value="http://purebeautyitaly.com/return">
    <input type="hidden" name="cancel_url" value="http://purebeautyitaly.com/cancel">
    <input type="hidden" name="notify_url" value="http://purebeautyitaly.com/notify">  
