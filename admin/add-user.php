...
$formData = backendUserDefaultFormData();

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $formData = backendUserBuildFormData($_POST);

    try {
        $errors = backendUserValidate($formData, $roleMap, $locationMap, true);

        if (backendUserExists($db, $formData['username'])) {
        ...
        $db->insertRow(
            'INSERT INTO users (username, password, first_name, last_name, email, user_level, activated, locked, profile, location_status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
            [
                $formData['username'],
                $formData['password'],
                $formData['first_name'],
        ...
        header('Location: manage-user.php?created=1');
        exit;
    } catch (Exception $e) {
        $message = $e->getMessage() ?: 'Unable to create backend user.';
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li><span>Add Backend User</span></li>
                </ul>
                <div class="page-toolbar">
                    <div class="btn-group pull-right">
                        <a href="manage-user.php" class="btn green btn-sm"><i class="fa fa-users"></i> Manage Users</a>
                    </div>
                </div>
            </div>

            <h3 class="page-title">Add Backend User</h3>
            ...
            <div class="portlet light bordered form-fit">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">New Backend User</span>
                    </div>
                </div>
                        ...
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="help-block">Used for backend login.</span>
                                </div>
                            </div>
                            <div class="form-group form-md-line-input">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="manage-user.php" class="btn default">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
