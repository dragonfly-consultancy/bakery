...
<div class="hor-menu" style="background-color: #090d16;">
    <ul class="nav navbar-nav" style="background-color: #090d16;">
        <!-- Dashboard -->
        <?php if ($canDashboard) { ?>
        <li class="classic-menu-dropdown" style="background-color: #090d16;">
        ...
        <li class="menu-dropdown classic-menu-dropdown " style="background-color: #090d16;">
            ...
            <ul class="dropdown-menu pull-left">
                ...
                <?php if (function_exists('hasPermission') ? hasPermission('settings.permissions') : true) { ?><li><a href="discount-code.php"><i class="fa fa-tag"></i> Discount Code</a></li><?php } ?>
                    <?php if (function_exists('hasPermission') ? hasPermission('settings.permissions') : true) { ?><li><a href="customer_product_discount.php"><i class="fa fa-calculator"></i> Customer Product Discount</a></li><?php } ?>
