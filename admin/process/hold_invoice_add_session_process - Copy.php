...
if(!empty($barcode_id)){
	...
	try {
		...
		$query_check_barcode_item = $db->getRow('SELECT temp.temp_car_d_id , temp.temp_car_h_id , temp.temp_car_d_item_id , temp.temp_car_d_qty , temp.temp_car_d_item_price , temp.temp_car_d_discount_type ,
		...
		$get_item_price =  $query_check_barcode_item['temp_car_d_item_price'];
