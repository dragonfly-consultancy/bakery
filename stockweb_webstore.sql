...
INSERT INTO `customer` (`customer_id`, `customer_email`, `customer_password`, `customer_activated`, `customer_locked`, `customer_title`, `customer_name`, `customer_nic`, `customer_avtive_code`, `customer_address`, `customer_discount`, `customer_tell`, `customer_mobile`, `customer_note`, `customer_outstanding_balance`, `customer_cradit_limite`, `new_customer`) VALUES
(241, 'rao@Gun.com', 'asd', 1, 0, NULL, 'Rao G', '1122334455', '83df18fe29d3628b856bb7343a2b637f', NULL, 0, 1234567, 456789345, NULL, 0.00, 0.00, 1),
(289, 'malith@sachi.com', 'asd', 0, 0, NULL, 'Malith Sachinthana', '', '4c65d65266c4a1432177ab4c74c0c43a', NULL, 0, 0, 2147483647, NULL, 0.00, 0.00, 1),
(307, 'amarasinghe.upul@gmail.com', '123', 1, 0, NULL, 'JAMES BOND', '', 'dc1a4fd6c32389fa8fbf6b0d6c85f0ab', NULL, 0, 0, 0, NULL, 0.00, 0.00, 0),
(305, 'gunneshwar@gmail.com', '1234', 0, 0, NULL, 'VSG Bha', '', 'e126bdc157efc7397f7ee28a6e507401', NULL, 0, 0, 493941449, NULL, 0.00, 0.00, 1),
(306, 'malith.sachinthana@gmail.com', 'asd', 1, 0, NULL, 'malith sachinthana', '', 'e48ea21f1e607435f64b28eba53ab095', NULL, 0, 2147483647, 2147483647, NULL, 0.00, 0.00, 0);
...
INSERT INTO `item_master` (`item_id`, `item_code`, `item_name`, `item_group`, `item_type`, `item_category`, `item_discription`, `item_uom`, `item_purchase_price`, `item_min_selling_price`, `item_normal_selling_price`, `others_selling_price`, `item_cash_selling_price`, `item_cradit_selling_price`, `item_promotion_status`, `item_promotion_price`, `item_image`, `imageParth`, `item_discount`, `item_active`, `item_warranty`, `item_barcode`, `is_hamper`, `item_has_sirial`, `item_vat`, `item_dispay_home`, `item_product_of_day`, `item_cod`, `item_mode`, `view_count`, `url`, `item_weight`, `immediate_pickups`) VALUES
(1, 'IG01', 'Classic White Bread Loaf', 1, 1, 1, '', 1, 1.00, 0.00, 1.00, 1.00, 0.00, 0.00, 0, 0.00, 'Classic-White-Bread-Loaf-1.png', 'images/product_img/2025/10/', 0.00, 'Y', '1', NULL, 0, 'N', 'N', 1, 0, 'enable', 'Normal', 0, 'Classic-White-Bread-Loaf-', 0.50, 'Yes'),
(2, 'IG02', 'Chocolate Fudge Cake (1kg)', 1, 2, 3, '', 1, 5.00, 0.00, 5.00, 5.00, 0.00, 0.00, 0, 0.00, 'Chocolate-Fudge-Cake-1kg-2.png', 'images/product_img/2025/10/', 0.00, 'Y', '1', NULL, 0, 'N', 'N', 1, 0, 'enable', 'Normal', 0, 'Chocolate-Fudge-Cake-1kg-2', 0.50, 'No');
...
INSERT INTO `supplier` (`supplier_id`, `supplier_name`, `supplier_address`, `supplier_contact_person`, `supplier_email`, `supplier_contact_no`, `supplier_note`, `supplier_outstanding_blance`, `supplier_cradit_limite`) VALUES
(13, 'Lee fast elivery', 'Monash rescent', 'Bret ee', 'Bret@Lee.com', '0759988300', 'Delivery very eek', 0.00, 0.00),
(14, 'Slow pin eliveries', 'Upper erntree ully, ictoria, ustralia', 'Shane arne', 'ShaneW@warneCompany.com', '0765643532', 'Googley in ayments', 0.00, 0.00);
...
(1, 'admin', 'admin_1122', 'Malith', '', 'malith.sachinthana@gmail.com', 1, 'Y', 'N', NULL, 1),
...
--
ALTER TABLE `invoice_details`
  MODIFY `invoice_d_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `invoice_hedder`
--
ALTER TABLE `invoice_hedder`
  MODIFY `invoice_h_id` int(1) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
