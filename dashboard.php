                            ...
                            <div class="col-12 col-md-3">
                                <div class="ps-widget ps-widget--product">
                                    <div class="ps-widget__block">
                                        <h4 class="ps-widget__title">Menu </h4><a class="ps-block-control" href="#"><i class="fa fa-angle-down"></i></a>
                                        <div class="ps-widget__content ps-widget__category">
                                            <ul class="menu--mobile">
                                                <li><a href="<?php echo site_url(); ?>dashboard.php" <?php echo site_url(); ?>assets class="nav-link">Dashboard</a></li>
                                                <li><a href="<?php echo site_url(); ?>account.php" <?php echo site_url(); ?>assets class="nav-link active">Personal Details</a></li>
                                                <li><a href="<?php echo site_url(); ?>passwordchange.php" <?php echo site_url(); ?>assets class="nav-link">Password Change</a></li>
                                                <li><a href="<?php echo site_url(); ?>orderhistory.php" <?php echo site_url(); ?>assets class="nav-link">Order History</a></li>
                                                <li><a href="<?php echo site_url(); ?>logout.php?logout=777" class="nav-link">logout</a></li>
